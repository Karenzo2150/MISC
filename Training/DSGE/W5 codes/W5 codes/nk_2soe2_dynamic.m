function [residual, g1, g2, g3] = nk_2soe2_dynamic(y, x, params, steady_state, it_)
%
...
residual(24)= lhs-rhs;
lhs =y(19);
rhs =params(7)*y(2)+(1-params(7))*(y(21)*params(8)+y(24)*params(9))+y(28);
residual(25)= lhs-rhs;
lhs =y(24);
