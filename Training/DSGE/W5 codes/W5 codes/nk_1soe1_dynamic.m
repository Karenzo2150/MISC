function [residual, g1, g2, g3] = nk_1soe1_dynamic(y, x, params, steady_state, it_)
%
...
residual(9)= lhs-rhs;
lhs =y(17);
rhs =params(9)*y(2)+(1-params(9))*(params(7)*y(18)+y(22)*params(8))+y(26);
residual(10)= lhs-rhs;
lhs =y(22);
