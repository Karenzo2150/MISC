function [residual, g1, g2, g3] = nk_2soe2_static(y, x, params)
%
...
residual(24)= lhs-rhs;
lhs =y(6);
rhs =y(6)*params(7)+(1-params(7))*(y(8)*params(8)+y(11)*params(9))+y(15);
residual(25)= lhs-rhs;
lhs =y(11);
...
if nargout >= 2,
  ...
  g1(24,13)=1;
  g1(25,6)=1-params(7);
  g1(25,8)=(-((1-params(7))*params(8)));
  g1(25,11)=(-((1-params(7))*params(9)));
  g1(25,15)=(-1);
  g1(26,2)=(-(1-params(3)));
