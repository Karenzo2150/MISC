...
M_.exo_names = char(M_.exo_names, 'e_fx');
M_.exo_names_tex = char(M_.exo_names_tex, 'e\_fx');
M_.exo_names_long = char(M_.exo_names_long, 'e_fx');
M_.endo_names = 'c';
M_.endo_names_tex = 'c';
...
M_.endo_names = char(M_.endo_names, 'fx');
M_.endo_names_tex = char(M_.endo_names_tex, 'fx');
M_.endo_names_long = char(M_.endo_names_long, 'fx');
...
M_.param_names = char(M_.param_names, 'rho_fx');
M_.param_names_tex = char(M_.param_names_tex, 'rho\_fx');
M_.param_names_long = char(M_.param_names_long, 'rho_fx');
...
erase_compiled_function('nk_3soe1b_static');
erase_compiled_function('nk_3soe1b_dynamic');
M_.orig_eq_nbr = 25;
M_.eq_nbr = 25;
M_.ramsey_eq_nbr = 0;
...
save('results3b_CITR','CITR_oo_','CITR_case_title');
save('nk_3soe1b_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('nk_3soe1b_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('nk_3soe1b_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('nk_3soe1b_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('nk_3soe1b_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('nk_3soe1b_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('nk_3soe1b_results.mat', 'oo_recursive_', '-append');
end
