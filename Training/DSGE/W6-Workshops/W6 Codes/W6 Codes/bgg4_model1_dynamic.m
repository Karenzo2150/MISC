function [residual, g1, g2, g3] = bgg4_model1_dynamic(y, x, params, steady_state, it_)
%
...
T256 = 1/params(3)*1/(1-params(4));
T260 = 1/params(3)*params(4)/(1-params(4));
T283 = (1-params(24))*(1-params(2)*params(24))/params(24)/(1+params(2)*params(25));
T338 = (1-params(21))*(1-params(2)*params(21))/(params(21)*(1+params(5)*params(23)));
lhs =params(42)*y(43);
...
residual(22)= lhs-rhs;
lhs =y(41);
rhs =y(27)*params(5)+y(24)*T256-y(1)*T260;
residual(23)= lhs-rhs;
lhs =y(28);
rhs =y(43)+y(30)-y(27);
residual(24)= lhs-rhs;
lhs =y(56);
rhs =params(2)/(1+params(2)*params(25))*y(69)+params(25)/(1+params(2)*params(25))*y(18)+T283*(y(30)-y(48));
residual(25)= lhs-rhs;
lhs =y(35);
rhs =y(34)*params(7)+y(9)*(1-params(7));
residual(26)= lhs-rhs;
lhs =y(36);
rhs =params(1)*(y(38)*params(14)-(params(14)-1)*(y(12)+y(2)-y(26))+y(10));
residual(27)= lhs-rhs;
lhs =y(25);
rhs =y(2)*params(28)+y(26)*(1-params(28))*params(29)+y(29)*(1-params(28))*params(30)+y(52)*(1-params(28))*params(31)+y(33);
residual(28)= lhs-rhs;
lhs =y(42);
rhs =params(22)*y(3)+T338*(y(41)-y(28))+params(2)*y(66)-y(26)*params(2)*params(22);
residual(29)= lhs-rhs;
lhs =y(42);
rhs =y(26)+y(28)-y(4);
residual(30)= lhs-rhs;
