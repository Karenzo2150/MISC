function [residual, g1, g2, g3] = bgg4_model0_static(y, x, params)
%
...
T235 = 1/params(3)*1/(1-params(4));
T239 = 1/params(3)*params(4)/(1-params(4));
T260 = (1-params(24))*(1-params(2)*params(24))/params(24)/(1+params(2)*params(25));
T311 = (1-params(21))*(1-params(2)*params(21))/(params(21)*(1+params(5)*params(23)));
lhs =params(42)*y(20);
...
residual(22)= lhs-rhs;
lhs =y(18);
rhs =y(4)*params(5)+y(1)*T235-y(1)*T239;
residual(23)= lhs-rhs;
lhs =y(5);
rhs =y(20)+y(7)-y(4);
residual(24)= lhs-rhs;
lhs =y(33);
rhs =y(33)*params(2)/(1+params(2)*params(25))+y(33)*params(25)/(1+params(2)*params(25))+T260*(y(7)-y(25));
residual(25)= lhs-rhs;
lhs =y(12);
rhs =y(11)*params(7)+y(12)*(1-params(7));
residual(26)= lhs-rhs;
lhs =y(13);
rhs =params(1)*(y(13)+y(15)*params(14)-(params(14)-1)*(y(2)+y(17)-y(3)));
residual(27)= lhs-rhs;
lhs =y(2);
rhs =y(2)*params(28)+y(3)*(1-params(28))*params(29)+y(6)*(1-params(28))*params(30)+y(29)*(1-params(28))*params(31)+y(10);
residual(28)= lhs-rhs;
lhs =y(19);
rhs =y(3)*params(22)+T311*(y(18)-y(5))+params(2)*y(19)-y(3)*params(2)*params(22);
residual(29)= lhs-rhs;
lhs =y(19);
rhs =y(3);
residual(30)= lhs-rhs;
