...
clear all
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 1. Model with the financial accelerator+dollarization and base monetary regime
...
clear classes
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 2. Model with the financial accelerator+dollarization and the manage float regime
dynare bgg4_model2a.mod 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
varble = {'rnom','y','pic','inv','qr','n','m','rer'};
names  ={'Nominal interest rate','GDP', 'Inflation rate','Investment','Asset prices','Net worth','Imports','Real exchange rate'};
[nper,junk1] = size(rnom_e_z);
...
for ii=1:nvar
    subplot(4,2,ii);
    plot(dates,resp_mat0(:,ii),'-or',dates,resp_mat1(:,ii),'-.r');
    if ii>6
    ...
    if ii==1
        legend('BGG+dollarization','BGG+dollarization+Managed Float');
    end
end
