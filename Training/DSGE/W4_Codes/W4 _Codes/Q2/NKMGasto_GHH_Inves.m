...
erase_compiled_function('NKMGasto_GHH_Inves_static');
erase_compiled_function('NKMGasto_GHH_Inves_dynamic');
M_.orig_eq_nbr = 15;
M_.eq_nbr = 15;
M_.ramsey_eq_nbr = 0;
...
nSS = M_.params( 19 );
QxSS = 1;
M_.params( 22 ) = (M_.params(9)-1)/M_.params(9);
mcSS = M_.params( 22 );
M_.params( 26 ) = 1/M_.params(4)-(1-M_.params(16));
rkSS = M_.params( 26 );
M_.params( 29 ) = M_.params(28)/M_.params(16);
k_y = M_.params( 29 );
M_.params( 15 ) = M_.params(26)*M_.params(29)*1/M_.params(22);
alfa = M_.params( 15 );
M_.params( 25 ) = M_.params(29)*M_.params(21);
kSS = M_.params( 25 );
M_.params( 27 ) = M_.params(25)^(-M_.params(15))*M_.params(19)^(-(1-M_.params(15)));
zYSS = M_.params( 27 );
M_.params( 24 ) = M_.params(16)*M_.params(25);
xSS = M_.params( 24 );
M_.params( 18 ) = M_.params(21)*(1-M_.params(28)-M_.params(5)/M_.params(21));
cSS = M_.params( 18 );
M_.params( 20 ) = M_.params(21)*M_.params(22)*(1-M_.params(15))/M_.params(19);
wSS = M_.params( 20 );
M_.params( 3 ) = M_.params(20)/M_.params(19)^M_.params(2);
thetaL = M_.params( 3 );
M_.params( 17 ) = (M_.params(18)-M_.params(3)/(1+M_.params(2))*M_.params(19)^(1+M_.params(2)))^(-M_.params(1));
lambdaSS = M_.params( 17 );
M_.params( 23 ) = M_.params(21)*(1-M_.params(22));
profSS = M_.params( 23 );
%
% INITVAL instructions
%
options_.initval_file = 0;
oo_.steady_state( 1 ) = log(M_.params(17));
oo_.steady_state( 2 ) = log(M_.params(18));
oo_.steady_state( 3 ) = log(M_.params(19));
...
oo_.steady_state( 9 ) = log(M_.params(23));
oo_.steady_state( 10 ) = log(M_.params(24));
oo_.steady_state( 11 ) = log(M_.params(25));
oo_.steady_state( 12 ) = log(QxSS);
oo_.steady_state( 13 ) = log(M_.params(26));
...
disp('-------------------------------------------------------------------------------------------------------------');
disp(' ');
save('NKMGasto_GHH_Inves_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('NKMGasto_GHH_Inves_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('NKMGasto_GHH_Inves_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('NKMGasto_GHH_Inves_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('NKMGasto_GHH_Inves_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('NKMGasto_GHH_Inves_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('NKMGasto_GHH_Inves_results.mat', 'oo_recursive_', '-append');
end
