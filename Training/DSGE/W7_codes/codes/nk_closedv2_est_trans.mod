...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% This file estimates the baseline NK model in the closed economy with US data (transformed)
...
parameters beta_C sigma h sigma_L theta_p chi_p phi_pic phi_y rho_a rho_g rho_z;
...
varobs pic_obs rnom_obs y_obs;

estimation(datafile='data_trans.csv',
mh_replic=5000,  
mh_nblocks=1,
mh_jscale=0.3,
mh_drop=0.2,
