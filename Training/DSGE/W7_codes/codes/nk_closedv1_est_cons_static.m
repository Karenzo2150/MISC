function [residual, g1, g2, g3] = nk_closedv1_est_cons_static(y, x, params)
%
...
lhs =y(1);
rhs =y(1)+(-params(2))*(y(2)-y(3))+params(2)*(1-params(10))*y(9);
residual(1)= lhs-rhs;
lhs =y(5);
...
residual(5)= lhs-rhs;
lhs =y(2);
rhs =y(3)*params(5)+y(6)*params(6)+y(10);
residual(6)= lhs-rhs;
lhs =y(6);
rhs =y(1);
residual(7)= lhs-rhs;
