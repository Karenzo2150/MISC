...
%% ... closed economy
%% ... with and without real wage rigidity
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Contacts
...
subplot(2,2,1);
p=plot(1:20,[sim_nk.X_EPS_A sim_rwage.X_EPS_A],'linewidth',2);
...
l=legend('NK basic','Real wage rigidity');
set(l,'Fontsize',12);
set(l,'Location','Best');

subplot(2,2,2);
p=plot(1:20,[sim_nk.YN_EPS_A sim_rwage.YN_EPS_A],'linewidth',2);
set(p(1),'linestyle','-');set(p(2),'linestyle','-.');
set(p(1),'linewidth',3);set(p(2),'linewidth',3);
set(p(1),'color','black');set(p(2),'color','red');
hold on;
...
subplot(2,2,3);
p=plot(1:20,[sim_nk.PI_EPS_A sim_rwage.PI_EPS_A],'linewidth',2);
set(p(1),'linestyle','-');set(p(2),'linestyle','-.');
set(p(1),'linewidth',3);set(p(2),'linewidth',3);
set(p(1),'color','black');set(p(2),'color','red');
hold on;
...
subplot(2,2,4);
p=plot(1:20,[sim_nk.INT_EPS_A sim_rwage.INT_EPS_A],'linewidth',2);
set(p(1),'linestyle','-');set(p(2),'linestyle','-.');
set(p(1),'linewidth',3);set(p(2),'linewidth',3);
set(p(1),'color','black');set(p(2),'color','red');
hold on;
...
subplot(2,2,1);
p=plot(1:20,[sim_nk.X_EPS_C sim_rwage.X_EPS_C],'linewidth',2);
set(p(1),'linestyle','-');set(p(2),'linestyle','-.');
set(p(1),'linewidth',3);set(p(2),'linewidth',3);
set(p(1),'color','black');set(p(2),'color','red');
hold on;
...
subplot(2,2,2);
p=plot(1:20,[sim_nk.MC_EPS_C sim_rwage.MC_EPS_C],'linewidth',2);
set(p(1),'linestyle','-');set(p(2),'linestyle','-.');
set(p(1),'linewidth',3);set(p(2),'linewidth',3);
set(p(1),'color','black');set(p(2),'color','red');
hold on;
...
subplot(2,2,3);
p=plot(1:20,[sim_nk.PI_EPS_C sim_rwage.PI_EPS_C],'linewidth',2);
set(p(1),'linestyle','-');set(p(2),'linestyle','-.');
set(p(1),'linewidth',3);set(p(2),'linewidth',3);
set(p(1),'color','black');set(p(2),'color','red');
hold on;
...
subplot(2,2,4);
p=plot(1:20,[sim_nk.INT_EPS_C sim_rwage.INT_EPS_C],'linewidth',2);
set(p(1),'linestyle','-');set(p(2),'linestyle','-.');
set(p(1),'linewidth',3);set(p(2),'linewidth',3);
set(p(1),'color','black');set(p(2),'color','red');
hold on;
...
subplot(2,2,1);
p=plot(1:20,[sim_nk.X_EPS_PI sim_rwage.X_EPS_PI],'linewidth',2);
set(p(1),'linestyle','-');set(p(2),'linestyle','-.');
set(p(1),'linewidth',3);set(p(2),'linewidth',3);
set(p(1),'color','black');set(p(2),'color','red');
hold on;
...
subplot(2,2,2);
p=plot(1:20,[sim_nk.MC_EPS_PI sim_rwage.MC_EPS_PI],'linewidth',2);
set(p(1),'linestyle','-');set(p(2),'linestyle','-.');
set(p(1),'linewidth',3);set(p(2),'linewidth',3);
set(p(1),'color','black');set(p(2),'color','red');
hold on;
...
subplot(2,2,3);
p=plot(1:20,[sim_nk.PI_EPS_PI sim_rwage.PI_EPS_PI],'linewidth',2);
set(p(1),'linestyle','-');set(p(2),'linestyle','-.');
set(p(1),'linewidth',3);set(p(2),'linewidth',3);
set(p(1),'color','black');set(p(2),'color','red');
hold on;
...
subplot(2,2,4);
p=plot(1:20,[sim_nk.INT_EPS_PI sim_rwage.INT_EPS_PI],'linewidth',2);
set(p(1),'linestyle','-');set(p(2),'linestyle','-.');
set(p(1),'linewidth',3);set(p(2),'linewidth',3);
set(p(1),'color','black');set(p(2),'color','red');
hold on;
...
subplot(2,2,1);
p=plot(1:20,[sim_nk.X_EPS_INT sim_rwage.X_EPS_INT],'linewidth',2);
set(p(1),'linestyle','-');set(p(2),'linestyle','-.');
set(p(1),'linewidth',3);set(p(2),'linewidth',3);
set(p(1),'color','black');set(p(2),'color','red');
hold on;
...
subplot(2,2,2);
p=plot(1:20,[sim_nk.MC_EPS_INT sim_rwage.MC_EPS_INT],'linewidth',2);
set(p(1),'linestyle','-');set(p(2),'linestyle','-.');
set(p(1),'linewidth',3);set(p(2),'linewidth',3);
set(p(1),'color','black');set(p(2),'color','red');
hold on;
...
subplot(2,2,3);
p=plot(1:20,[sim_nk.PI_EPS_INT sim_rwage.PI_EPS_INT],'linewidth',2);
set(p(1),'linestyle','-');set(p(2),'linestyle','-.');
set(p(1),'linewidth',3);set(p(2),'linewidth',3);
set(p(1),'color','black');set(p(2),'color','red');
hold on;
...
subplot(2,2,4);
p=plot(1:20,[sim_nk.INT_EPS_INT sim_rwage.INT_EPS_INT],'linewidth',2);
set(p(1),'linestyle','-');set(p(2),'linestyle','-.');
set(p(1),'linewidth',3);set(p(2),'linewidth',3);
set(p(1),'color','black');set(p(2),'color','red');
hold on;
