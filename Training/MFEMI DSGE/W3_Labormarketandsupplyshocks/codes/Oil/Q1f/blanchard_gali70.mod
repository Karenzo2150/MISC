...
%% ... Calibration for the 1970s, with strict inflation targeting policy (lines 67-68)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Contact
...
/*
 * This file implements the Blanchard and Gali (2007) model on Oil Price Shocks.
 *
 */
