...
erase_compiled_function('nk_real_wage_rigid_static');
erase_compiled_function('nk_real_wage_rigid_dynamic');
M_.orig_eq_nbr = 11;
M_.eq_nbr = 11;
M_.ramsey_eq_nbr = 0;
...
M_.params( 5 ) = 6;
EPSILON = M_.params( 5 );
M_.params( 6 ) = (1-M_.params(4))*(1-M_.params(4)*M_.params(3))/M_.params(4);
KAPPA = M_.params( 6 );
M_.params( 7 ) = 0.9;
GAMMA_W = M_.params( 7 );
M_.params( 8 ) = 2.5;
...
save('nk_real_wage_rigid_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('nk_real_wage_rigid_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('nk_real_wage_rigid_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('nk_real_wage_rigid_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('nk_real_wage_rigid_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('nk_real_wage_rigid_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('nk_real_wage_rigid_results.mat', 'oo_recursive_', '-append');
end
