...
sigma_L     = 1;
theta_p     = 0.75;
theta_px    = 0.75*0+0.0001; //0.0001 or 0.75
...
@#if DITR == 1
    ...
    save('results4b_DITR','DITR_oo_','DITR_case_title');
@#else
    @#if CITR ==1
         CITR_oo_ = oo_;
         CITR_case_title = case_title;
         save('results4b_CITR','CITR_oo_','CITR_case_title');
    @#else
        @#if PEG ==1
             PEG_oo_ = oo_;
             PEG_case_title = case_title;
             save('results4b_PEG','PEG_oo_','PEG_case_title');
        @#else
            @#if DITR_F ==1
                 DITR_F_oo_ = oo_;
                 DITR_F_case_title = case_title;
                 save('results4b_DITR_F','DITR_F_oo_','DITR_F_case_title');
            @#else
