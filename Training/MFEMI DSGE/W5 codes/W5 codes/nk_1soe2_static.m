function [residual, g1, g2, g3] = nk_1soe2_static(y, x, params)
%
...
residual(9)= lhs-rhs;
lhs =y(6);
rhs =y(6)*params(9)+(1-params(9))*(y(8)*params(7)+y(11)*params(8))+y(15);
residual(10)= lhs-rhs;
lhs =y(11);
...
residual(12)= lhs-rhs;
lhs =y(20);
rhs =y(20)*1/params(1)+params(3)*(y(3)+y(5))-params(3)*(y(4)+y(16)-params(10)*(y(4)-y(5)));
residual(13)= lhs-rhs;
lhs =y(19);
rhs =y(7)-y(23);
residual(14)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(9,13)=1;
  g1(10,6)=1-params(9);
  g1(10,8)=(-((1-params(9))*params(7)));
  g1(10,11)=(-((1-params(9))*params(8)));
  g1(10,15)=(-1);
  g1(11,2)=(-(1-params(3)));
